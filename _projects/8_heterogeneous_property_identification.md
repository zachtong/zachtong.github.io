...
card_description: An inverse mechanics framework that identifies property fields from a single instrumented test while using measured boundary conditions.
importance: 1
category: "Material Mechanics & Model Validation"
featured: true
year: 2025–present
status: In progress
